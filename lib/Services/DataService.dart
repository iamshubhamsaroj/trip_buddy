...
class DataService extends GetxController {
  ...
  void addExpense(String tripId, String desc, int amount, String date,
      List paidBy, List splitBy, List billList) async {
    try {
      ...
      if (billList.isNotEmpty) {
        for (int i = 0; i < billList.length; i++) {
          UploadTask uploadTask1 = FirebaseStorage.instance
              .ref()
              .child("Trips/$tripId/expenses/$desc/Bill ${i + 1}")
              .putFile(File(billList[i]));
